            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="?page=riwayat&actions=tampil">Riwayat Barang</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="?page=barang&actions=report">Laporan Barang</a></li>
						            <li><a href="?page=riwayat&actions=report">Laporan Riwayat Barang</a></li>
                    </ul>
                </li>
                ...
                <li><a href="?page=biodata&actions=kelompok">Biodata Kelompok</a></li>
