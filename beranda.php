    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert ">
                ...
                color:#030303;"> <marquee direction="left" scrollamount="10" height="45px" width="100%" >Selamat Datang Di Sistem Informasi Persediaan Barang Gudang</marquee></span>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Arsip Data Barang</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">Kode</th><th>Nama Barang</th><th>Satuan</th><th>Jenis</th><th>Stok</th>
                            </tr>
                        </thead>
                        <tbody>
